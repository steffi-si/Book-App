    ...
    <div className="random-list-wrapper">
      ...
      {selectedBook && (
        <div className="selected-book-wrapper">
          ...
          <p>
            <strong>ISBN: </strong>
            {selectedBook.isbn ? selectedBook.isbn[0] : "Unknown"}
          </p>
          <p>
            <strong>Publisher: </strong>
            {selectedBook.publisher ? selectedBook.publisher[0] : "Unknown"}
          </p>
          <p>
            <strong>Number of pages: </strong>
            {selectedBook.number_of_pages || "Unknown"}
          </p>
          <p>
          ...
          {selectedBook.ebook_access === "borrowable" && (
            <p>
              <strong>Ebook available: </strong>Yes (Borrowable)
            </p>
          )}
          {selectedBook.ebook_count_i > 0 && (
            <p>
              <strong>Ebook count: </strong>
              {selectedBook.ebook_count_i}
            </p>
          )}
